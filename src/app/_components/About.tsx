  ...
  return (
    <div id="about" className="flex flex-col">
      <div className="p-10 grid gap-10 grid-cols-1 md:grid-cols-3 justify-between">
        {/* left side */}
        <div className="md:col-span-1 flex flex-col md:sticky md:top-10 md:h-fit items-center justify-center">
          <div className="flex flex-col gap-6 justify-center items-center w-full">
            <p className="text-xl lg:text-2xl text-center">Nice to meet you!</p>
            <h4 className="text-3xl lg:text-5xl font-bold uppercase text-center">Welcome to...</h4>

            <div className="flex flex-col justify-center items-center text-center gap-4 w-full">
              <Image src={myImage} alt="myImage" className="w-full max-w-xs" />
        ...
        <div className="col-span-1 md:col-span-2 flex flex-col justify-start">
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 border-b-2 py-10 mb-10">
              {/* phone */}
              <Link
                href="https://api.whatsapp.com/send/?phone=%2B201113404148&text&type=phone_number&app_absent=0"
                target="_blank"
              ...
              {/* Mail */}
              <Link
                href="mailto:mahmoudsayed.2003.8@email.com"
                target="_blank"
                className="block hover:text-gray-300 transition-colors"
              >
                <div className="flex justify-start items-center gap-2">
                  ...
                  <span className="break-all">mahmoudsayed.2003.8@email.com</span>
                </div>
              </Link>
            ...
            <div className="col-span-1 mb-8">
              <h5 className="font-bold flex gap-2 justify-start items-center mb-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                <span className="bg-gradient text-transparent bg-clip-text font-semibold">
                  Mahmoud Sayed
                </span>
                . I am a Frontend Developer with hands-on experience building responsive and
            ...
            {/* note */}
            <div className="bg-black rounded-lg dark:bg-white flex justify-center items-center p-6 shadow-xl">
              <p className="font-bold text-7xl md:text-9xl text-gray-500 flex justify-center items-center leading-none">&quot;</p>
              <p className="text-white dark:text-black font-semibold text-lg md:text-xl leading-relaxed">
                &quot;You might not think of programmers as artists, but programming is a very creative
                profession. It&apos;s creativity based on logic.&quot; - <span className="font-bold">John Romero</span>
              </p>
            </div>
          </div>
        </div>
